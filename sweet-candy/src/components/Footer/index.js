            ...
            <div className={styles.todasAsInformacoesFooter}>
                <div className={styles.cardFooter}>
                    ...
                    <div className={styles.displayInformacao}>
                        <Image className={styles.iconesFooter} src="/Image/contato.jpg" alt="Contato" width={25} height={25} />
                        <Link className={styles.contatofooter} href="">Contato</Link>
                    </div>
        
                    <div className={styles.displayInformacao}>
                        <Image className={styles.iconesFooter} src="/Image/telefone.jpg" alt="Telefone:" width={25} height={25} />
                        <p className={styles.miniInformacao}>+ 55 (99) 9999-9999</p>
                    </div>
        
                    <div className={styles.displayInformacao}>
                        <Image className={styles.iconesFooter} src="/Image/gmail.jpg" alt="E-mail: " width={25} height={25} />
                ...
                <div className={styles.cardFooter}>
                    ...
                    <div className={styles.displayInformacao}>
                        <Image className={styles.iconesFooter} src="/Image/insta.jpg" alt="Instagram: " width={25} height={25} />
                    ...
                    <div className={styles.divLocalizacao}>
                        ...
                        <div className={styles.displayInformacao}>
                            <Image className={styles.iconesFooter} src="/Image/localizacao.jpg" alt="Localização: " width={25} height={25} />
