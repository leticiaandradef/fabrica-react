      ...
      <div className={styles.container}>
        ...
        <div className={styles.bloco}>
          <p className={styles.p}>
            Rua:
            <input type="text" className={styles.input} placeholder="Digite a rua" />
          </p>
          <p className={styles.p}>
            Número da casa:
            <input
          ...
          <p className={styles.p}>
            Bairro:
            <input type="text" className={styles.input} placeholder="Digite o bairro" />
          </p>
          <p className={styles.p}>
            Complemento:
            <input type="text" className={styles.input} placeholder="Ex: apto 101" />
          </p>
        </div>
